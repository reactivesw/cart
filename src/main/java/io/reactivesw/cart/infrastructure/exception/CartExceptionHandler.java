 ...
 */
@Component
public class CartExceptionHandler implements ExceptionHandler, HandlerExceptionResolver {

  private static Logger logger = LoggerFactory.getLogger(CartExceptionHandler.class);
